...
import { showsWorkText, workLabel } from '@/lib/portfolio';
...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}) {
 ...
 return {title:work?`${workLabel(work,'zh')} — TDDD`:'TDDD',description:work&&showsWorkText(work)?work.description.zh:undefined};
}
