...
export function Footer({lang}:{lang:Language}) {
  const t=copy[lang];
  return <footer className="section-wrap site-footer"><a className="footer-wordmark" href="#top">TDDD<span>✳</span></a><div><p>© {new Date().getFullYear()} TDDD · 泰迪迪迪</p><p>{t.footer}</p></div><a href="#top" className="top-link">{t.up} ↑</a></footer>;
}
